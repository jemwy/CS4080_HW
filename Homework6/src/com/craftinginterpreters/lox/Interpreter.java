...
class Interpreter implements Expr.Visitor<Object>,
    ...
    public Object visitSetExpr(Expr.Set expr) {
        ...
        LoxFunction setter = instance.findSetter(expr.name.lexeme);
        if (setter != null) {
            setter.bind(instance).call(this, java.util.Arrays.asList(value));
            return value;
        }
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        Map<String, LoxFunction> setters = new HashMap<>();
        ...
        for (Stmt.Function method : stmt.methods) {
            ...
            if (method.isStatic) {
                ...
                setters.put(method.name.lexeme, function);
            } else {
    ...
    public Object visitInnerExpr(Expr.Inner expr) {
        ...
        int distance = resolved[0];

        return environment.getAt(distance, "inner");
    }

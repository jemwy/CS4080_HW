...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
  ...
  private static class Variable {
    ...
    Variable(Token name, int index, boolean defined, boolean used) {
        this.name = name;
        this.index = index;
  ...
  public Void visitClassStmt(Stmt.Class stmt) {
    ...
    if (stmt.superclass != null) {
      ...
      scopes.peek().put("super", new Variable(null, index, true, true));
    }

    beginScope();
    Map<String, Variable> scope = scopes.peek();
    int index = scope.size();
    scope.put("this", new Variable(null, index, true, true));

    int innerIndex = scope.size();
    scope.put("inner", new Variable(null, innerIndex, true, true));
  ...
  private void declare(Token name) {
    ...
    scope.put(name.lexeme, new Variable(name, index, false, false));
  }
